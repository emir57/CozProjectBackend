...
namespace CozProject.Business.Concrete
{
    public class AnswerWriteManager : WriteBaseService<Answer, AnswerWriteDto, AnswerReadDto>, IAnswerWriteService
    {
        ...
        [SecuredOperation("Admin,Teacher")]
        public override IResult Delete(AnswerWriteDto writeDto)
        {
            return base.Delete(writeDto);
        }
        ...
        [SecuredOperation("Admin,Teacher")]
        public override IResult DeleteRange(List<AnswerWriteDto> writeDtos)
        {
            return base.DeleteRange(writeDtos);
        }
    }
}
